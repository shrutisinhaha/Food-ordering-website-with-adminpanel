       ...
       <br><br><br>
        ...
        <table class="tbl-full">
            ...
            <?php
               ...
               //create serial number variable and assign vallue as 1
               $sn=1;
               ...
               if($count>0)
               {
                ...
                while($row=mysqli_fetch_assoc($res))
                {
                    ...
                    //to add css inside php , break the php
                    ?>
                                ...
                                <?php
                                 //check whether image name is available or not
                                  if($image_name!="")
                                  {
                                    //display the image
                                    ?>
                                    <!-- image tag to display the image in html, source link to our image given to the website -->
